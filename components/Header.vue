<template>
  <div class="navbar bg-base-100 fixed top-0 left-0 w-screen h-16 shadow-lg z-50">
      ...
      <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
        ...
        <li>
          ...
          >
              ...
              <NuxtLink
                to="/"
                class="font-bold btn btn-ghost text-xl rounded-md"
              >
                <div class="w-8">
                  <img
                    src="/img/coffee.gif"
  ...
  <div class="navbar-end">
        <div class="w-10">
          <label class="swap swap-rotate">
            ...
            <input type="checkbox" class="theme-controller" value="synthwave" data-toggle-theme="night,autumn" data-act-class="autumn"/>
