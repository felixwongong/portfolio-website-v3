<template>
  <header class="max-w-screen-lg m-16 mx-auto bg-opacity-20">
    <GameCanvas class="w-full h-full" />
    <div
      class="text-wrapper flex flex-row justify-center font-bungee text-3xl font-bold"
    >
      <span style="--i: 8">IN</span>
      <span> </span>
